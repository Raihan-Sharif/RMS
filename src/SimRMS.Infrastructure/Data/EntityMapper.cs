...
{
    /// <summary>
    /// Infrastructure implementation of entity mapping using LB.DAL
    /// Contains database-specific mapping logic
    /// </summary>
    ...
    //                { "UsrAssct", "UsrAssct" },
    //                { "UsrAssctPwd", "UsrAssctPwd" },
    //                { "UsrAccessFa", "UsrAccessFA" },
    //                { "UsrBtxmode", "UsrBTXMode" },
    //                { "WithoutClntList", "WithoutClntList" },
    //                { "Bfesname", "BFESName" },
    //                { "ThirdPartyUsrId", "ThirdPartyUsrID" },
    //                { "GtcexpiryPeriod", "GTCExpiryPeriod" },
    //                { "UsrGtdmode", "UsrGTDMode" },
    //                { "MarketDepth", "MarketDepth" },
    //                { "MktDepthStartDate", "MktDepthStartDate" },
    //                { "MktDepthEndDate", "MktDepthEndDate" },
    //                { "CrOrderDealer", "CrOrderDealer" },
    //                { "Category", "Category" },
    //                { "UsrChannel", "UsrChannel" },
    //                { "Pid", "PID" },
    //                { "PidRms", "PID_rms" },
    //                { "Pidflag", "PIDFlag" },
    //                { "PidflagRms", "PIDFlag_rms" },
    //                { "ChannelUpdFlag", "ChannelUpdFlag" },
    //                { "MimosMigrateDt", "MimosMigrateDt" },
    //                { "MimosMigrateDtRms", "MimosMigrateDt_rms" },
    //                { "OriUsrEmail", "OriUsrEmail" }
    //            }
    //        };
