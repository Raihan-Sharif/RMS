...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        #region Client Stock Validators
        services.AddScoped<IValidator<GetClientStockListRequest>, GetClientStockListRequestValidator>();
        services.AddScoped<IValidator<GetClientStockByKeyRequest>, GetClientStockByKeyRequestValidator>();
        services.AddScoped<IValidator<CreateClientStockRequest>, CreateClientStockRequestValidator>();
        services.AddScoped<IValidator<UpdateClientStockRequest>, UpdateClientStockRequestValidator>();
        services.AddScoped<IValidator<DeleteClientStockRequest>, DeleteClientStockRequestValidator>();
        services.AddScoped<IValidator<AuthorizeClientStockRequest>, AuthorizeClientStockRequestValidator>();
        services.AddScoped<IValidator<GetClientStockWorkflowListRequest>, GetClientStockWorkflowListRequestValidator>();
        #endregion

        #region Stock Exposure Validators
        services.AddScoped<IValidator<CreateStockExposureRequest>, CreateStockExposureRequestValidator>();
        services.AddScoped<IValidator<UpdateStockExposureRequest>, UpdateStockExposureRequestValidator>();
        services.AddScoped<IValidator<DeleteStockExposureRequest>, DeleteStockExposureRequestValidator>();
        services.AddScoped<IValidator<AuthorizeStockExposureRequest>, AuthorizeStockExposureRequestValidator>();
        services.AddScoped<IValidator<GetStockExposureWorkflowListRequest>, GetStockExposureWorkflowListRequestValidator>();
        #endregion

        #region Exchange Validators
        services.AddScoped<IValidator<CreateExchangeRequest>, CreateExchangeRequestValidator>();
        services.AddScoped<IValidator<UpdateExchangeRequest>, UpdateExchangeRequestValidator>();
        services.AddScoped<IValidator<DeleteExchangeRequest>, DeleteExchangeRequestValidator>();
        services.AddScoped<IValidator<AuthorizeExchangeRequest>, AuthorizeExchangeRequestValidator>();
        services.AddScoped<IValidator<GetExchangeWorkflowListRequest>, GetExchangeWorkflowListRequestValidator>();
        #endregion
