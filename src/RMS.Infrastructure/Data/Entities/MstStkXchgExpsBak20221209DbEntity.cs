...
public partial class MstStkXchgExpsBak20221209DbEntity
{
    ...
    public bool? XchgExpsCheckIdssgross { get; set; }

    public decimal? XchgExpsIdssgrossAmt { get; set; }

    public decimal? XchgExpsIdssgrossAmtTopUp { get; set; }

    public decimal? XchgExpsIdssgrossDayOrder { get; set; }

    public decimal? XchgExpsIdssgrossPrevDayOrder { get; set; }

    public bool? XchgExpsCheckIdss { get; set; }

    public decimal? XchgExpsIdssamt { get; set; }

    public decimal? XchgExpsIdssamtTopUp { get; set; }

    public decimal? XchgExpsIdssdayOrder { get; set; }

    public decimal? XchgExpsIdssprevDayOrder { get; set; }
}
