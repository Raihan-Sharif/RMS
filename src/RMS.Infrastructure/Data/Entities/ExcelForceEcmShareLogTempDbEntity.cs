...
public partial class ExcelForceEcmShareLogTempDbEntity
{
    public DateTime? DtCreateDate { get; set; }

    public string? SRecDirection { get; set; }

    public string? SEfstatus { get; set; }
    ...
    public string? ActualContNo { get; set; }
