...
public partial class MstStkExpsBak20221209DbEntity
{
    ...
    public int? ShariahIslamicAcc { get; set; }

    public bool? StkExpsCheckIdssgross { get; set; }

    public decimal? StkExpsIdssgrossAmt { get; set; }

    public decimal? StkExpsIdssgrossAmtTopUp { get; set; }

    public decimal? StkExpsIdssgrossDayOrder { get; set; }

    public decimal? StkExpsIdssgrossPrevDayOrder { get; set; }

    public bool? StkExpsCheckIdss { get; set; }

    public decimal? StkExpsIdssamt { get; set; }

    public decimal? StkExpsIdssamtTopUp { get; set; }

    public decimal? StkExpsIdssdayOrder { get; set; }

    public decimal? StkExpsIdssprevDayOrder { get; set; }
}
