...
public partial class OrderPlacedDbEntity
{
    ...
    public int? XchgGtd { get; set; }

    public int? PrevMatchedQty { get; set; }

    public int? ShariahAccount { get; set; }

    public string? SettlementCurrency { get; set; }

    public int? BuyBckQty { get; set; }

    public bool? Idssflag { get; set; }

    public int? LinkOrderSeqNo { get; set; }

    public string? ClOrdLinkId { get; set; }

    public decimal? EarmarkAdjAmount { get; set; }

    public int? EarmarkAdjQty { get; set; }
