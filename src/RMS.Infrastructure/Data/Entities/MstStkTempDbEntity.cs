...
public partial class MstStkTempDbEntity
{
    ...
    public decimal? StkBestBuyPrice { get; set; }

    public decimal? StkBestSellPrice { get; set; }

    public decimal? StkHighestLastDonePrice { get; set; }

    public decimal? StkLowestLastDonePrice { get; set; }

    public decimal? StkHighestBuyPrice { get; set; }

    public decimal? StkLowestBuyPrice { get; set; }

    public decimal? StkHighestSellPrice { get; set; }

    public decimal? StkLowestSellPrice { get; set; }
}
