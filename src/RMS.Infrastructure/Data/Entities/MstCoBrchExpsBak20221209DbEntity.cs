...
public partial class MstCoBrchExpsBak20221209DbEntity
{
    ...
    public bool? CoBrchExpsCheckIdssgross { get; set; }

    public decimal? CoBrchExpsIdssgrossAmt { get; set; }

    public decimal? CoBrchExpsIdssgrossAmtTopUp { get; set; }

    public decimal? CoBrchExpsIdssgrossDayOrder { get; set; }

    public decimal? CoBrchExpsIdssgrossPrevDayOrder { get; set; }

    public bool? CoBrchExpsCheckIdss { get; set; }

    public decimal? CoBrchExpsIdssamt { get; set; }

    public decimal? CoBrchExpsIdssamtTopUp { get; set; }

    public decimal? CoBrchExpsIdssdayOrder { get; set; }

    public decimal? CoBrchExpsIdssprevDayOrder { get; set; }
}
